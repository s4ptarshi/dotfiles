...
PluginSettings {
    ...
    StyledRect {
        ...
        Column {
            ...
            StringSetting {
                settingKey: "workSoundPath"
                label: "Work Complete Sound"
                description: "Full path to sound file (e.g. /home/user/sounds/bell.wav)"
                placeholder: "/usr/share/sounds/freedesktop/stereo/complete.oga"
                defaultValue: ""
            }

            StringSetting {
                settingKey: "breakSoundPath"
                label: "Break Complete Sound"
                description: "Full path to sound file (e.g. /home/user/sounds/coffee.wav)"
                placeholder: "/usr/share/sounds/freedesktop/stereo/message.oga"
                defaultValue: ""
            }
        }
    }
